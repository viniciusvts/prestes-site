    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="caption">
                    <h1 class="font-lato"><?php echo $financiamentoEscolhido = get_queried_object()->name;?></h1>
                    <div class="center">
                ...
                <img class="d-block w-100" src="<?php echo(get_theme_mod( 'dnaTheme_setting_ImgTaxFinanc')); ?>" alt="First slide">
            </div>      
        </div>
    </div>
</div>
...
<?php
    $empreendimentos = new WP_Query(array('post_type' => 'imoveis', 'order' => 'ASC', 'taxonomy' => 'financiamento', 'posts_per_page'=>'-1'));
        ...
        <div class="row">
            <?php
                while($empreendimentos->have_posts()): $empreendimentos->the_post();                    
                    ...
                    $financiamentosComparas = $financiamentos;
                    foreach($financiamentosComparas as $financiamentoComparada):
                        if($financiamentoComparada->name == $financiamentoEscolhido):
