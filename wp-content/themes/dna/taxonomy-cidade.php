    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="caption">
                    <h1 class="font-lato">Imóveis em <?php echo $cidadeEscolhida = get_queried_object()->name; ?></h1>
                    <div class="center">
                        <?php echo file_get_contents("wp-content/themes/dna/svg/line-color.svg"); ?>
                    </div>
                    <div id="sub-title">
                        <h3>A melhor escolha para você e sua família. Confira!</h3>
                    </div>
                    <div class="blockPress-btn mt-5"> <a href="#consultant" class="bttn">Faça uma simulação</a></div>
                </div>
                <img class="d-block w-100" src="<?php echo(get_theme_mod( 'dnaTheme_setting_ImgHeadTaxCidade')); ?>" alt="First slide">
            </div>      
        </div>
    </div>
</div>
...
<?php
    $empreendimentos = new WP_Query(array('post_type' => 'imoveis', 'orderby' => 'date', 'posts_per_page'=>'100'));
...
<section id="development">
    ...
    <div class="blockPress-btn"> <a href="#consultant" class="bttn">Faça uma simulação</a></div>
</section>
<?php endif; ?>
